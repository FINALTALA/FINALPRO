...
| BDR-015 | FYP Delivery Increment accepted as the build-scope reconciliation | The full confirmed scope (BDR-001–013) is documented as the target design; a narrower, explicitly-scoped increment is what the 2-person/3-month team actually builds first | Part 1, D.4 — status tracked as OPEN-006 above (proceeding without objection, formal sign-off still recommended) |
